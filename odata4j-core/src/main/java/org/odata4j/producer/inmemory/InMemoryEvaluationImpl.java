...
public class InMemoryEvaluationImpl implements InMemoryEvaluation {

  @Override
  public Object evaluate(CommonExpression expression, Object target, PropertyModel properties) {
  ...
  private String evaluateToString(CommonExpression expression, Object target, PropertyModel properties) {
  ...
  @Override
  public boolean evaluate(BoolCommonExpression expression, Object target, PropertyModel properties) {
  ...
  private boolean evaluate(BoolMethodExpression expression, Object target, PropertyModel properties) {
  ...
  private Object binaryFunction(BinaryCommonExpression be,
  ...
  private boolean equals(BinaryCommonExpression be, Object target,
  ...
  private int compareTo(BinaryCommonExpression be, Object target, PropertyModel properties) {
    ObjectPair pair = new ObjectPair(be.getLHS(), be.getRHS(), target, properties);
    binaryNumericPromotion(pair);
    return compareTo(be, pair);
  }

  protected int compareTo(BinaryCommonExpression expression, ObjectPair pair) {
    //noinspection unchecked
    return ((Comparable) pair.lhs).compareTo(pair.rhs);
  }
